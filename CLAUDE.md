...
| `packages/decisions/`                   | DMN simulation, analysis and test running (`@bpmiq/decisions`): same engine as the dmn-js simulation add-on in the widget, headless. Owns `<decision>.tests.yaml` and the `node packages/decisions/cli.ts` gate.                                                                                           |
